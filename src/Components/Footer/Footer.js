					...
					<Col sm={6} className="logos">
						{data && data.logos.map((value, index)=>{
							if (value.logo_secondary){
								return(
								<div key={index}>
									<a href="http://dev-teensmart-team-orange.pantheonsite.io" ><Image className="logo" src={`http://dev-teensmart-team-orange.pantheonsite.io${value.logo_primary}`} alt="TeenSmart" /></a>
									<a href="http://dev-teensmart-team-orange.pantheonsite.io" ><Image className="logo" src={`http://dev-teensmart-team-orange.pantheonsite.io${value.logo_secondary}`} alt="JovenSalud" /></a>
								</div>
							)
							}else{
								return(<a href="http://dev-teensmart-team-orange.pantheonsite.io" ><Image className="logo" src={`http://dev-teensmart-team-orange.pantheonsite.io${value.logo_primary}`} alt="TeenSmart" /></a>)
							}
						})}
